...
public class ProgressBarForm extends javax.swing.JDialog
{
  ...
  public ProgressBarForm(java.awt.Frame parent, boolean modal)
  {
    super(parent, modal);
    initComponents();
    ...
    try
    {
      ...
      for (int i = 0; i < musicas.length; i++)
      {
        ...
        if ((baseFileFormat instanceof org.tritonus.share.sampled.file.TAudioFileFormat))
        {
          ...
          lbAcao.setText("Agregando " + val + ".mp3");
          musica.setNome(val);
  ...
  private void initComponents()
  {
    ...
    jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Progresso da ação", 0, 0, new java.awt.Font("Arial", 1, 14)));
    
    jLabel2.setFont(new java.awt.Font("Arial", 1, 14));
    jLabel2.setText("Accion:");
    
    lbAcao.setText("Accion");
  ...
  public static void main(String[] args)
  {
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        ProgressBarForm dialog = new ProgressBarForm(new javax.swing.JFrame(), true);
